document.addEventListener('DOMContentLoaded', function() {
    ...
    submitButton.addEventListener('click', function() {
        ...
        saveUserAnswersFirestore(userAnswers, scores, totalScore);
    ...
    function saveUserAnswersFirestore(userAnswers, scores, totalScore) {
        const answersCollection = db.collection('userAnswers');
        ...
        .then((docRef) => {
            ...
            // Optionally, you can notify the user or perform other actions upon successful save
        })
        .catch((error) => {
